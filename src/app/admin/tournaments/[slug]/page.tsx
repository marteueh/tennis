  ...
  return (
    <div style={{ maxWidth: 980, margin: '0 auto', padding: '32px 24px', fontFamily: "'DM Sans', sans-serif" }}>
      <nav style={{ marginBottom: 18, fontSize: 12, color: '#7A7870' }}>
        <Link href="/admin/tournaments" style={{ color: '#534AB7', textDecoration: 'none' }}>← Tutti i tornei</Link>
        <span style={{ margin: '0 8px', color: 'rgba(26,26,26,0.2)' }}>·</span>
        <Link href={`/tornei/${tournament.slug}`} target="_blank" style={{ color: '#7A7870', textDecoration: 'none' }}>
      ...
      <Section title="Riquadri culturali (libri, film, pubblicità...)">
        <p style={{ fontSize: 12, color: '#7A7870', marginBottom: 14, lineHeight: 1.5 }}>
