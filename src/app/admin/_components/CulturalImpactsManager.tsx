...
const LEVEL_OPTIONS: { value: string; label: string; color: string }[] = [
  { value: 'direct',     label: 'Diretto',    color: '#534AB7' },
  { value: 'contextual', label: 'Contestuale', color: '#7A7870' },
  { value: 'archetypal', label: 'Archetipo',   color: '#C8A85C' },
]
  ...
  return (
    <div>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 16 }}>
        {items.length === 0 && (
          <p style={{ fontSize: 12, color: 'rgba(26,26,26,0.4)', fontStyle: 'italic', padding: '16px 0' }}>
      ...
      >
        <summary style={{
          ...
          color: '#534AB7', listStyle: 'none',
        }}>
          + Aggiungi nuovo riquadro
        </summary>
        <div style={{ borderTop: '1px solid rgba(83,74,183,0.15)', padding: '16px' }}>
    ...
    >
      <summary style={{
        ...
        <span style={{
          ...
          padding: '2px 6px', background: 'rgba(26,26,26,0.05)', color: '#7A7870', borderRadius: 2,
        }}>
          {typeLabel}
        </span>
        ...
        {item.year && (
          <span style={{ fontSize: 11, color: '#7A7870', fontVariantNumeric: 'tabular-nums' }}>
            {item.year}
          </span>
        )}
        <span style={{
      ...
      <div style={{ padding: '12px 14px', borderTop: '1px solid rgba(26,26,26,0.06)' }}>
    ...
    <form action={saveCulturalImpact} style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
      ...
      <button
        ...
        style={{
          ...
          padding: '8px 18px', background: '#534AB7', color: '#FFFFFF',
