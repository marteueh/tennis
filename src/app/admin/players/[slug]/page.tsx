  ...
  return (
    <div style={{ maxWidth: 980, margin: '0 auto', padding: '32px 24px', fontFamily: "var(--font-sans)" }}>
      ...
      <nav style={{ marginBottom: 18, fontSize: 12, color: 'var(--muted)' }}>
        <Link href="/admin/players" style={{ color: 'var(--accent)', textDecoration: 'none' }}>← Tutti i giocatori</Link>
        <span style={{ margin: '0 8px', color: 'rgba(var(--ink-rgb),0.2)' }}>·</span>
        <Link href={`/giocatori/${player.slug}`} target="_blank" style={{ color: 'var(--muted)', textDecoration: 'none' }}>
      ...
      <div style={{ marginBottom: 28, display: 'flex', alignItems: 'flex-start', gap: 20 }}>
        ...
        {player.photo_url && (
          <div style={{ width: 90, aspectRatio: '3/4', position: 'relative', border: '1px solid rgba(var(--ink-rgb),0.08)', flexShrink: 0 }}>
            <Image
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              padding: '8px 18px', background: 'var(--gold)', color: '#FFFFFF',
