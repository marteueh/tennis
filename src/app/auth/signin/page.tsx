...
export default async function SignInPage({ searchParams }: Props) {
  ...
  return (
    <div style={{ maxWidth: 440, margin: '60px auto', padding: '0 24px', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 32, color: '#1A1A1A', marginBottom: 8 }}>
        Entra nella conversazione
      </h1>
      <p style={{ fontSize: 14, lineHeight: 1.7, color: '#7A7870', marginBottom: 28 }}>
      ...
      <form action={login} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        <div>
          <label style={{ display: 'block', fontSize: 10, fontWeight: 500, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#7A7870', marginBottom: 6 }}>
            Email
          </label>
          <input
            type="email"
            ...
            style={{
              ...
              border: '1px solid rgba(26,26,26,0.2)', borderRadius: 2,
        ...
        <button
          ...
          style={{
            ...
            padding: '12px', background: '#534AB7', color: '#FFFFFF',
      ...
      <p style={{ marginTop: 28, fontSize: 11, color: 'rgba(26,26,26,0.45)', lineHeight: 1.7 }}>
      ...
      <p style={{ marginTop: 14, fontSize: 11, color: 'rgba(26,26,26,0.4)' }}>
